...
`test/` is the Forge port: 276 tests against the real storage layout, covering the same
...
FORGE.md. It first compiled on 2026-08-24 at 140 tests, and all 276 pass now.
...
test` reported 140 of 140 then and reports 276 of 276 now: 2,048 fuzz runs across four
